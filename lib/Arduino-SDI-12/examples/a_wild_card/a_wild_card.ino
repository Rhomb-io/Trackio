...
#define SERIAL_BAUD 38400  // The baud rate for the output serial port
#define DATA_PIN 24         // The pin of the SDI-12 data bus
#define POWER_PIN 0       // The sensor power pin (or -1 if not switching power)
